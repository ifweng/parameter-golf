...
RUN_ROOT="${RUN_ROOT:-$WORKSPACE_ROOT/runs/pr1855_exp01_seed42}"
...
echo "PR1855 Exp01 workspace data bootstrap"
...
ENV_PATH="$WORKSPACE_ROOT/pr1855_exp01_data.env"
...
echo "Wrote $ENV_PATH"
echo
echo "PR1855 Exp01 requires lrzip when COMPRESSOR=pergroup:"
echo "sudo apt-get update && sudo apt-get install -y lrzip"
echo
echo "Next single-seed 1-GPU benchmark command:"
echo "source $ENV_PATH"
echo 'NPROC_PER_NODE=1 SEEDS="42" bash frontier/lanes/pr1855_exp01_awqlite_asymlogit/run_8xh100.sh'
echo
echo "After seed 42 looks good, run a narrow 8xH100 confirmation:"
echo "source $ENV_PATH"
echo 'NPROC_PER_NODE=8 RUN_ROOT=/workspace/runs/pr1855_exp01_3seed SEEDS="42 0 1234" bash frontier/lanes/pr1855_exp01_awqlite_asymlogit/run_8xh100.sh'
